    ...
    async function fetchJournals() {
      try {
        ...
        if (!institute || institute === 'all') {
          response = await axios.get('https://apiforcollegeblogs-t63y.onrender.com/api/institute/all');
        } else {
          response = await axios.get(`https://apiforcollegeblogs-t63y.onrender.com/api/institute/${institute}`);
        }
        if (!response) {
          response = await axios.get('https://apiforcollegeblogs-t63y.onrender.com/api/institute');
        }
