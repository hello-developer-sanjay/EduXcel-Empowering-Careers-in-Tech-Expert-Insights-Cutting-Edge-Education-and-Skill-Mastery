    ...
    async function fetchCareers() {
      try {
        ...
        if (!vision || vision === 'all') {
          response = await axios.get('https://eduxcel-api-5aug.onrender.com/api/careers/vision/all');
        } else {
          response = await axios.get(`https://eduxcel-api-5aug.onrender.com/api/careers/vision/${vision}`);
        }
        if (!response) {
          response = await axios.get('https://eduxcel-api-5aug.onrender.com/api/careers/vision');
        }
