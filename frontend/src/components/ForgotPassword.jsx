...
function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://eduxcel-api-16july.onrender.com/api/forgotpassword', { email });
  ...
  return (
    ...
    <title> Recover Your Account | EduXcel: Forgot Password</title>
 <meta
   name="description"
 ...
 <meta property="og:title" content="  Recover Your Account | EduXcel: Forgot Password" />
 ...
 <meta property="og:url" content="https://eduxcel.vercel.app/forgot-password" />
 ...
 <meta property="og:site_name" content=" Recover Your Account | EduXcel: Forgot Password" />
  <link rel="canonical" href="https://eduxcel.vercel.app/forgot-password" />

 <meta name="twitter:card" content="summary_large_image" />
 <meta name="twitter:title" content=" Recover Your Account | EduXcel: Forgot Password" />
