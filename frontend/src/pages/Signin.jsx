      ...
      if (token) {
        ...
        try {
          ...
          const profileResponse = await axios.get(
            'https://eduxcel-backend.onrender.com/api/profile',
            {
              headers: {
          ...
          // No need to set the state here since UserProfile component will handle it
        ...
        window.addEventListener('message', async (event) => {
          ...
          if (
            event.origin === 'https://eduxcel-backend.onrender.com' &&
            event.data.token
          ) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://eduxcel-backend.onrender.com/api/signin',
        formData
      );
